  ...
  return (
    <div className="w-full grid grid-cols-9 gap-10 lgl:gap-0 px-6">
      ...
      <div className="col-span-9 md:col-span-4">
        <ResumeTitle title="التصميم" icon={<SiArtstation />} />
        {/* web Design */}
        <div className="py-4">
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">التصوير الإحترافي</p>
          ...
          {/* web Development */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">التصوير الجوي</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
          ...
          {/* UI Design */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">مجموعة أدوبي</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
            ...
            {/* UI Design */}
            <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">قيادة الحاسب الألي</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[80%] h-full absolute top-0 left-0 bg-designColor"></span>
            </span>
          </div>
      ...
      <div className="col-span-9 md:col-span-4">
        <ResumeTitle title="اللغات" icon={<FaFlag />} />
        {/* English */}
        <div className="py-4">
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">العربية</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
          ...
          {/* Hindi */}
          <div className="py-3 border-b-[1px] border-zinc-800">
            <p className="text-base text-textColor -mb-1.5">الإنكليزية</p>
            <span className="w-full bg-zinc-600 h-1 inline-flex relative">
              <span className="w-[90%] h-full absolute top-0 left-0 bg-designColor"></span>
            </span>
          </div>
